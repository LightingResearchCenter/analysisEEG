...
xlswrite('HRstats_results_norm3.xls', data, 'HR');
...
xlswrite('HRstats_results_norm3.xls', data, 'CV');
...
xlswrite('HRstats_results_norm3.xls', data, 'STD');
...
xlswrite('HRstats_results_norm3.xls', data, 'RMS');
...
xlswrite('HRstats_results_norm3.xls', data, 'P50');

%deleteEmptyExcelSheets('P:\hamner\ONR_EEG_JUNE_2012\matlab\HRstats_results_norm3.xls');