...
% THE First run is to save the data to the disk as Excel files
for s = 1:length(sub)
    ...
    if(~exist(savename, 'file'))
        eegData{s}.data = OkamotoPS_func_notrigger(path(s,:), savename, sub(s), period(s), trial(s), color(s));
        close all
        datestr(now)
    end
end
...
%     num(:,q) = [];
    ...
    dhalpha(sub(s) - 49, period(s) + 3*(trial(s) - 1)) = mean([ps(340:341);ps(420:421)]);
    
    %beta is 13 - 30 Hz on Fz and Cz
    dbeta(sub(s) - 49, period(s) + 3*(trial(s) - 1)) = mean([ps(185:219);ps(265:299)]);
    
    %theta is 5 - 7 Hz on Fz and Cz
    dtheta(sub(s) - 49, period(s) + 3*(trial(s) - 1)) = mean([ps(169:173);ps(249:253)]);
    
    %alpha-theta is 5 - 9 Hz on all channels
    datheta(sub(s) - 49, period(s) + 3*(trial(s) - 1)) = mean([ps(169:177);ps(249:257);ps(329:337);ps(409:417)]);
    
    %high-beta is 18 - 21 Hz on Fz and Cz
    dhbeta(sub(s) - 49, period(s) + 3*(trial(s) - 1)) = mean([ps(195:201);ps(275:281)]);
...
%     num(:,q) = [];
    ...
    %alpha is 8 - 12 Hz on Pz and Oz
    ralpha(sub(s) - 49, period(s) + 3*(trial(s) - 1)) = mean([ps(335:343);ps(415:423)]);
    
    %high alpha is 10.5 - 11 Hz on Pz and Oz
    rhalpha(sub(s) - 49, period(s) + 3*(trial(s) - 1)) = mean([ps(340:341);ps(420:421)]);
    
    %beta is 13 - 30 Hz on Fz and Cz
    rbeta(sub(s) - 49, period(s) + 3*(trial(s) - 1)) = mean([ps(185:219);ps(265:299)]);
    
    %theta is 5 - 7 Hz on Fz and Cz
    rtheta(sub(s) - 49, period(s) + 3*(trial(s) - 1)) = mean([ps(169:173);ps(249:253)]);
    
    %alpha-theta is 5 - 9 Hz on all channels
    ratheta(sub(s) - 49, period(s) + 3*(trial(s) - 1)) = mean([ps(169:177);ps(249:257);ps(329:337);ps(409:417)]);
    
    %high-beta is 18 - 21 Hz on Fz and Cz
    rhbeta(sub(s) - 49, period(s) + 3*(trial(s) - 1)) = mean([ps(195:201);ps(275:281)]);
...
%     num(:,q) = [];
    ...
    %alpha is 8 - 12 Hz on Pz and Oz
    walpha(sub(s) - 49, period(s) + 3*(trial(s) - 1)) = mean([ps(335:343);ps(415:423)]);
    
    %high alpha is 10.5 - 11 Hz on Pz and Oz
    whalpha(sub(s) - 49, period(s) + 3*(trial(s) - 1)) = mean([ps(340:341);ps(420:421)]);
    
    %beta is 13 - 30 Hz on Fz and Cz
    wbeta(sub(s) - 49, period(s) + 3*(trial(s) - 1)) = mean([ps(185:219);ps(265:299)]);
    
    %theta is 5 - 7 Hz on Fz and Cz
    wtheta(sub(s) - 49, period(s) + 3*(trial(s) - 1)) = mean([ps(169:173);ps(249:253)]);
    
    %alpha-theta is 5 - 9 Hz on all channels
    watheta(sub(s) - 49, period(s) + 3*(trial(s) - 1)) = mean([ps(169:177);ps(249:257);ps(329:337);ps(409:417)]);
    
    %high-beta is 18 - 21 Hz on Fz and Cz
    whbeta(sub(s) - 49, period(s) + 3*(trial(s) - 1)) = mean([ps(195:201);ps(275:281)]);
...
xlswrite('LRCSummary_norm3.xls', data, 'alpha');
...
xlswrite('LRCSummary_norm3.xls', data, 'halpha');
...
xlswrite('LRCSummary_norm3.xls', data, 'beta');
...
xlswrite('LRCSummary_norm3.xls', data, 'theta');
...
xlswrite('LRCSummary_norm3.xls', data, 'atheta');
...
xlswrite('LRCSummary_norm3.xls', data, 'hbeta');

deleteEmptyExcelSheets('C:\LRC\2012_FALL\EEG_ONR_DAY\HAMNER\matlab\LRCSummary_norm3.xls');
