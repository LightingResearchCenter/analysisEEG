...
%     num(:,q) = [];
    ...
    dalpha(sub(s) - 65, period(s) + 3*(trial(s) - 1)) = median([ps(335:343);ps(415:423)]);
    
    %high alpha is 10.5 - 11 Hz on Pz and Oz
    dhalpha(sub(s) - 65, period(s) + 3*(trial(s) - 1)) = median([ps(340:341);ps(420:421)]);
    
    %beta is 13 - 30 Hz on Fz and Cz
    dbeta(sub(s) - 65, period(s) + 3*(trial(s) - 1)) = median([ps(185:219);ps(265:299)]);
    
    %theta is 5 - 7 Hz on Fz and Cz
    dtheta(sub(s) - 65, period(s) + 3*(trial(s) - 1)) = median([ps(169:173);ps(249:253)]);
    
    %alpha-theta is 5 - 9 Hz on all channels
    datheta(sub(s) - 65, period(s) + 3*(trial(s) - 1)) = median([ps(169:177);ps(249:257);ps(329:337);ps(409:417)]);
    
    %high-beta is 18 - 21 Hz on Fz and Cz
    dhbeta(sub(s) - 65, period(s) + 3*(trial(s) - 1)) = median([ps(195:201);ps(275:281)]);
...
%     num(:,q) = [];
    ...
    %alpha is 8 - 12 Hz on Pz and Oz
    ralpha(sub(s) - 65, period(s) + 3*(trial(s) - 1)) = median([ps(335:343);ps(415:423)]);
    
    %high alpha is 10.5 - 11 Hz on Pz and Oz
    rhalpha(sub(s) - 65, period(s) + 3*(trial(s) - 1)) = median([ps(340:341);ps(420:421)]);
    
    %beta is 13 - 30 Hz on Fz and Cz
    rbeta(sub(s) - 65, period(s) + 3*(trial(s) - 1)) = median([ps(185:219);ps(265:299)]);
    
    %theta is 5 - 7 Hz on Fz and Cz
    rtheta(sub(s) - 65, period(s) + 3*(trial(s) - 1)) = median([ps(169:173);ps(249:253)]);
    
    %alpha-theta is 5 - 9 Hz on all channels
    ratheta(sub(s) - 65, period(s) + 3*(trial(s) - 1)) = median([ps(169:177);ps(249:257);ps(329:337);ps(409:417)]);
    
    %high-beta is 18 - 21 Hz on Fz and Cz
    rhbeta(sub(s) - 65, period(s) + 3*(trial(s) - 1)) = median([ps(195:201);ps(275:281)]);
...
%     num(:,q) = [];
    ...
    %alpha is 8 - 12 Hz on Pz and Oz
    walpha(sub(s) - 65, period(s) + 3*(trial(s) - 1)) = median([ps(335:343);ps(415:423)]);
    
    %high alpha is 10.5 - 11 Hz on Pz and Oz
    whalpha(sub(s) - 65, period(s) + 3*(trial(s) - 1)) = median([ps(340:341);ps(420:421)]);
    
    %beta is 13 - 30 Hz on Fz and Cz
    wbeta(sub(s) - 65, period(s) + 3*(trial(s) - 1)) = median([ps(185:219);ps(265:299)]);
    
    %theta is 5 - 7 Hz on Fz and Cz
    wtheta(sub(s) - 65, period(s) + 3*(trial(s) - 1)) = median([ps(169:173);ps(249:253)]);
    
    %alpha-theta is 5 - 9 Hz on all channels
    watheta(sub(s) - 65, period(s) + 3*(trial(s) - 1)) = median([ps(169:177);ps(249:257);ps(329:337);ps(409:417)]);
    
    %high-beta is 18 - 21 Hz on Fz and Cz
    whbeta(sub(s) - 65, period(s) + 3*(trial(s) - 1)) = median([ps(195:201);ps(275:281)]);
...
figure(5)
plot(1:9, nanmean(dhbeta), 'k')
hold on
plot(1:9, nanmean(rhbeta), 'r')
plot(1:9, nanmean(whbeta), 'b')
ylabel('\fontsize{16}Relative Power')
xlabel('\fontsize{16}Period #')
legend('Dark', 'Red', 'White', 'location', 'northwest')
set(gca, 'fontsize', 16)
title('\fontsize{16}HBeta-LRC')
...
xlswrite('LRCSummary_median_norm3.xls', data, 'alpha');
...
xlswrite('LRCSummary_median_norm3.xls', data, 'halpha');
...
xlswrite('LRCSummary_median_norm3.xls', data, 'beta');
...
xlswrite('LRCSummary_median_norm3.xls', data, 'theta');
...
xlswrite('LRCSummary_median_norm3.xls', data, 'atheta');
...
for i = 9:9:length(sub)
    ...
    data(i/9 + 1,:) = {dsub(i/9) whbeta(i/9, 1) whbeta(i/9, 2) whbeta(i/9, 3) whbeta(i/9, 4) whbeta(i/9, 5) whbeta(i/9, 6) whbeta(i/9, 7) whbeta(i/9, 8) whbeta(i/9, 9) rhbeta(i/9, 1) rhbeta(i/9, 2) rhbeta(i/9, 3) rhbeta(i/9, 4) rhbeta(i/9, 5) rhbeta(i/9, 6) rhbeta(i/9, 7) rhbeta(i/9, 8) rhbeta(i/9, 9) dhbeta(i/9, 1) dhbeta(i/9, 2) dhbeta(i/9, 3) dhbeta(i/9, 4) dhbeta(i/9, 5) dhbeta(i/9, 6) dhbeta(i/9, 7) dhbeta(i/9, 8) dhbeta(i/9, 9)};
end
xlswrite('LRCSummary_median_norm3.xls', data, 'hbeta');

deleteEmptyExcelSheets('\\root\public\hamner\ONR_EEG_NIGHT_JULY_2012\matlab\LRCSummary_median_norm3.xls');
